...
function AboutModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-lg bg-neutral-white dark:bg-neutral-slate-800 text-neutral-slate-900 dark:text-neutral-slate-100">
        <DialogHeader>
          ...
          {fields.map(({ label, key }) => {
            ...
            return (
              <div key={key}>
                ...
                <p className="text-sm text-neutral-slate-700 dark:text-neutral-slate-300 leading-relaxed">{value}</p>
              </div>
            );
          })}
        </div>

        <div className="flex flex-wrap gap-2 pt-4 border-t border-neutral-slate-100 dark:border-neutral-slate-700">
          {item.tags.map((tag) => (
...
export function Portfolio() {
  ...
  return (
    <section ref={ref} id="portfolio" className="py-24 bg-neutral-slate-50 dark:bg-neutral-slate-900">
      <div className="container mx-auto px-6">
        ...
        >
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-neutral-slate-900 dark:text-neutral-slate-100 mb-6">
              Portfolio Overview
            </h2>
            <p className="text-xl text-neutral-slate-600 dark:text-neutral-slate-400 max-w-3xl mx-auto">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h3 className="text-2xl font-bold text-neutral-slate-900 dark:text-neutral-slate-100">{section.category}</h3>
                  </div>
                          ...
                          <CardContent className="flex flex-col flex-1 justify-between">
                            ...
                            <div className="flex flex-col gap-2">
                              ...
                              <Button
                                variant="ghost"
                                size="sm"
                                className="gap-2 w-full text-neutral-slate-500 hover:text-neutral-slate-800 dark:text-neutral-slate-400 dark:hover:text-neutral-slate-200"
