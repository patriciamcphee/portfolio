...
| :white_check_mark: **DO** | :no_entry_sign: **DON'T** |
| --- | --- |
| <pre><code> \* One item<br /> \* Second item<br /> \* Third item<br /> \* Fourth item<br /> \* Fifth item</code></pre>  | <pre><code> \* One item<br /> \+ Second item<br /> \- Third item<br /> \* Fourth item<br /> \+ Fifth item</code></pre>  |
...
<Alert severity="success">You can also use an <a href="http://www.tablesgenerator.com/markdown_tables">online table generator</a>.</Alert>
