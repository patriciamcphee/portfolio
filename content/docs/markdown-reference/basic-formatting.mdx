...
description: >-
  Explore the basic and universal markdown formatting used in a Docusaurus-based
  site.
keywords:
  - markdown
  - markdown formatting
...
Avoid using. Use the [Admonitions](advanced-formatting.mdx#admonitions) instead.
