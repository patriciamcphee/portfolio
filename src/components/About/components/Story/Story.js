      ...
      <Grid container spacing={4} direction={isMd ? 'row' : 'column'}>
        <Grid item container alignItems={'center'} xs={12} md={8}>
          ...
          <Typography variant="p" align="left" paragraph={true} gutterBottom={true}>
            ...
            <Typography variant="p" align="left" paragraph={true} gutterBottom={true}>
            My journey into content design/strategy started with the Human-Centered Design & Engineering team at a large telecommunications company. There I learned how to conduct usability tests (participant observation) to uncover and solve user experience challenges with end-user documentation.  
            </Typography>
            <Typography variant="p" align="left" paragraph={true} gutterBottom={true}>
