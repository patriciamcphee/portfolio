...
About 12 years ago, I started to explore different careers like Medical Writer, Voiceover/Voice Actor ([listen to my demos](https://soundcloud.com/patriciamcphee/sets/voiceover-demos)), or returning to my roots as a Graphic Designer. I even considered transitioning to UX/UI Designer, Instructional Designer, or Web Developer. However, after exploring these possibilities, I decided to learn Full Stack Web Development first and then get certified in UX Design.  
