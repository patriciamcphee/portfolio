...
- **Description:** My client provided 26 pre-recorded how-to videos with scripts to do the voiceover, but some of the scripts needed work, and the video had no audio to reference. I needed to be resourceful, so I found a PDF of the user guide, which helped, but to write a quality script, I needed to watch the video many times to add context to the actions in the video. I edited and produced audio and video.
- **My Role:** Freelance Copywriter, Voiceover Artist
- **Tools:** Audacity, Adobe Premiere Pro, Microsoft Word
...
<ReactPlayer controls='false' url='https://youtu.be/dmeztPJfQcg' />
