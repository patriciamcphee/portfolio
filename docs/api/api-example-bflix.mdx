...
<List sx={{ width: '100%', bgcolor: 'background.paper', color: '#000000', borderRadius: 4 }}>
  <ListItem sx={{py: 0}}>
    ...
    <ListItemText primary="Project" secondary="CareerFoundry assignment; write an API for a movie app" />
  </ListItem>
  <ListItem sx={{py: 0}}>
    <ListItemAvatar>
      <Avatar>
    ...
    <ListItemText primary="Description" secondary="Written for the b-movie app I've been developing." />
  </ListItem>
  <ListItem sx={{py: 0}}>
    <ListItemAvatar>
      <Avatar>
    ...
    <ListItemText primary="Date" secondary="July 8, 2022" />
  </ListItem>
</List>
</Container>
<br />
