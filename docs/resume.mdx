...
Worked collaboratively with the product core engineering team to develop user guides and a scenario-based deployment guide. Wrote and edited in-platform UX microcopy (error and warning messages, and welcome instructions). Conducted audits of existing content to identify areas for improvement. Built an online help system using the Docusaurus docs-as-code framework.
...
| --- | --- | --- | --- |
| Docs-as-Code | Docusaurus<br />(React/Node.js) | <ul><li>Author</li><li>Information Architect</li></ul> | <ul><li>A Tech Securuty Startup (2021-2022)</li><li>Netdata (2020)</li></ul> | 
