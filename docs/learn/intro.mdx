...
- Different document frameworks and the platforms for each (Docs-as-code vs. DITA vs. HTML/CSS)
...
- Identify poorly written job descriptions that have everything and the kitchen sink
