...
description: >-
  Learn how to write effective release notes that inform users about new
  features, enhancements, and bug fixes in your product.
keywords:
  - release notes
  - changelogs
  - user-facing changes
...
<img
  id="uielement5"
  src='../../docs/images/new-onboarding.png'
