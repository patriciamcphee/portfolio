...
- **Project:** Voice assistant for ficticious luxury vacation destination  (certificate project)
- **Company:** N/A
...
import LuxuryVillaLogo from '../../static/img/fulllogo_transparent_nobuffer.png';

<img src={LuxuryVillaLogo} width="30%" id="diagrams" alt="Example banner" />

Luxury Villas Inc. rents 5000 vacation houses at 20 different locations worldwide. 

Our large beach houses offer exclusive, high-quality services in a traditional VIP setting for high-income families earning $100,000 or more per year. 

Guests can ask the virtual concierge questions about the villa and about things to do in the area so guests don't miss any highlights, such as the golf clinic for kids or the chef's dinner on Thursday.
...
<table>
  ...
  <td>Wife is vegan, so need to have vegan on the menu. Something with a kid-friendly vibe.</td>
  </tr>
    <tr>
