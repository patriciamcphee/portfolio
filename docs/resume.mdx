...
<!-- Include file -->
I'm a Sr. Content Designer and UX Writer in the Tech Industry for 25 years, starting in support and moving to network system administration. However, for the past two decades, I've been a Technical Writer taking the guesswork out of complex technical content. I started my technical writing career in the late 1990s on the Human Factors (Human-Centered Design & Engineering) team at a large telecommunications company. There, I learned how to conduct usability tests (participant observation) to uncover and solve user experience (UX) challenges early in my career.  
...
Content Design Lead for the Expedia Group Design System (EGDS) platform and work at the intersection of components, code, and end-user documentation.

**Microsoft/Kforce**<br />
**Content Developer, Contractor**<br /> 
100% Remote <br /> 
May 2020 - October 2021 

Worked collaboratively with the Azure Dedicated engineering and UX Research teams to develop scenario and goal-based content. Write and edit UX microcopy and UI strings. Conduct audits of existing content to identify areas for improvement. Use qualitative and quantitative data to make data-driven decisions.
...
- Content design, content strategy, UX writing, technical writing \| 100%
