      ...
      <>
        <p>Before you can contribute to the SCOOBY documentation, you'll need to install and set up the tools.</p>
            ...
            <Row justify="space-between">
                ...
                <Col span={22}><p>At this point in your journey....</p></Col>
              </Row>
...
<Row justify="space-between">
                <Col span={1} offset={1}><p><CheckCircleFilled style={{ fontSize: '24px', color: '#9ecd28' }} /></p></Col>
                <Col span={22}><p>Up to this point, you have the tools installed, your workspace or working directory set up, and the docs-next repo cloned. You're done!</p></Col>
              </Row>
