...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div><strong>Unable to save "Q4:Report.xlsx"</strong></div>
      <div>The file name contains invalid characters. File names can't include: / \ : * ? &quot; &lt; &gt; |</div>
    </div>
  </div>
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div><strong>Can't upload "presentation.pptx"</strong></div>
      <div>File size: 47 MB<br />
      Maximum allowed: 25 MB<br /><br />
      Compress the file or upgrade to a Pro account for 100 MB uploads.</div>
    </div>
  </div>
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    <div className="px-5 py-3 bg-utility-red-20 border-b border-(--border)">
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div><strong>Connection timeout</strong></div>
      <div>We couldn't reach the server at api.example.com.</div>
      <ul>
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div><strong>We couldn't process your payment</strong></div>
      <div>Your card ending in 4242 was declined by your bank.</div>
      <div>Check your card details or try a different payment method.</div>
    </div>
  </div>
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    <div className="px-5 py-3 bg-utility-red-20 border-b border-(--border)">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div>Payment failed. You entered incorrect card information.</div>
      <br /><br />
    </div>
  </div>
</div>
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      ...
      <div>Try again, or select "Forgot password" to reset your password.</div>
    </div>
  </div>
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    <div className="px-5 py-3 bg-utility-red-20 border-b border-(--border)">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      ...
      <div>✗ Password incorrect for user@example.com</div>
    </div>
  </div>
</div>
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div>Unable to load account information</div>
      <div>We're having technical difficulties. Try again in a few moments. If this continues, contact support.</div>
      <div>Error code: DB_500</div>
    </div>
  </div>
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    <div className="px-5 py-3 bg-utility-red-20 border-b border-(--border)">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div>MySQL error: Table 'prod_users.accounts' doesn't exist</div>
      <div>Can't connect to internal server prod-db-01.internal.company.com:3306</div>
      <div>Stack trace: at DatabaseController.fetchUser (/var/www/app/controllers/db.js:247)</div>
    </div>
  </div>
</div>
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div>Can't load your profile. Refresh the page or try again later.</div>
      <div>Unable to connect to the server. Check your internet connection and try again.</div>
      <div>Something went wrong. Try again. If this keeps happening, contact support.</div>
    </div>
  </div>
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    <div className="px-5 py-3 bg-utility-red-20 border-b border-(--border)">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div>NullReferenceException in UserController</div>
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div>Enter a valid email address (example@domain.com)</div>
      <div>Incorrect username or password. Try again or reset your password.</div>
      <div>Add a subject line to send your message</div>
    </div>
  </div>
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    <div className="px-5 py-3 bg-utility-red-20 border-b border-(--border)">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div>You entered invalid data</div>
      <div>Your password is wrong</div>
      <div>You must include a subject line</div>
    </div>
  </div>
</div>
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div>Delete "Project_Final.doc"? This can't be undone. [Cancel] [Delete]</div>
      <div>Can't save changes. [Try Again] [Save Copy] [Cancel]</div>
      <div>Connection lost. Reconnecting... [Manual Retry] [Work Offline]</div>
    </div>
  </div>
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    <div className="px-5 py-3 bg-utility-red-20 border-b border-(--border)">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div>Are you sure? Yes/No</div>
      <div>Operation failed. OK</div>
      <div>Error occurred. Dismiss</div>
    </div>
  </div>
</div>
...
<div className="not-prose grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      ...
      <div>Import complete: 1,247 records added</div>
      <div>System check passed: All services running normally</div>
    </div>
  </div>
  <div className="rounded-lg border border-(--border) bg-(--card) overflow-hidden">
    <div className="px-5 py-3 bg-utility-red-20 border-b border-(--border)">
    ...
    <div className="px-5 py-4 text-sm text-(--foreground)">
      <div>Error: Operation completed successfully</div>
      <div>Failed to succeed</div>
      <div>Warning: No problems found</div>
    </div>
  </div>
</div>
